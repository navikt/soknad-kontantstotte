node() {
    ...
    stage('Build and Push'){
      ...
      sh "docker build -t repo.adeo.no:5443/soknad-kontantstotte:$tagName -f ./docker/Dockerfile ./ --build-arg HTTPS_PROXY=$HTTPS_PROXY --build-arg HTTP_PROXY=$HTTP_PROXY"
