...
enum BarnTypeKeys {
    HENT_FORTROLIG_ADRESSE = 'BARN_HENT_FORTROLIG_ADRESSE',
    HENT = 'BARN_HENT',
...
interface IBarnHentFortroligAdresse extends Action {
    type: BarnTypeKeys.HENT_FORTROLIG_ADRESSE;
}
...
function barnHentFortroligAdresse(): IBarnHentFortroligAdresse {
    return {
        type: BarnTypeKeys.HENT_FORTROLIG_ADRESSE,
    };
}
