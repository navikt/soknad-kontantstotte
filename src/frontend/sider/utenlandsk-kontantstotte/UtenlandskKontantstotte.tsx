...
const UtenlandskKontantstotte: React.StatelessComponent<UtenlandskKontantstotteSideProps> = ({
    ...
    const { mottarKontantstotteFraUtlandet, mottarKontantstotteFraUtlandetTilleggsinfo } =
        utenlandskKontantstotte;
                ...
                {mottarKontantstotteFraUtlandet.verdi === Svar.JA && (
                    <TilleggsinformasjonInput
                        label={intl.formatMessage({
                            id: 'utenlandskKontantstotte.mottarKontantstotteFraUtlandet.tilleggsinfo.sporsmal',
                        })}
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(UtenlandskKontantstotte));
