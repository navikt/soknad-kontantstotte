...
const BarnehageplassskalBegynneInfo: React.StatelessComponent<BarnehageplassskalBegynneInfoProps> =
    ({
        intl,
        brukFlertall,
        feltMedFeil,
                ...
                <div className={'inputSkjemaGruppe__inner'}>
                    ...
                    <Input
                        ...
                        label={intl.formatMessage(
                            brukFlertall
                                ? {
                                      id: 'barnehageplass.skalBegynneIBarnehage.antallTimer.sporsmal.flertall',
                                  }
                                : {
...
const mapStateToProps = (state: IRootState): IMapStateToProps => {
    return {
        skalBegynneIBarnehageAntallTimer:
            selectBarnehageplass(state).skalBegynneIBarnehageAntallTimer,
