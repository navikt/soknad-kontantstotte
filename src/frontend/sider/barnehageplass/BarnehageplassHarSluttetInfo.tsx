        ...
        <SkjemaGruppe className={'soknad__inputSkjemaGruppe'}>
            <div className={'inputSkjemaGruppe__inner'}>
                <Input
                    ...
                    feil={hentFeilmeldingElement(feltMedFeil.harSluttetIBarnehageDato)}
                    maxLength={10}
                />
                <Input
                    className={'inputElement'}
                    label={intl.formatMessage(
                        brukFlertall
                            ? {
                                  id: 'barnehageplass.harSluttetIBarnehage.antallTimer.sporsmal.flertall',
                              }
                    ...
                    feil={hentFeilmeldingElement(feltMedFeil.harSluttetIBarnehageAntallTimer)}
                    type={'tel'}
                    autoComplete={'off'}
                    maxLength={5}
                />
                <Input
                    ...
                    feil={hentFeilmeldingElement(feltMedFeil.harSluttetIBarnehageKommune)}
                    maxLength={50}
                />
